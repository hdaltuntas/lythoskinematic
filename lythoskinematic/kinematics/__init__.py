"""
lythoskinematic.kinematics — kinematik tarama çekirdeği (Markland testi + Monte Carlo).

SlopeKinematics'in hesap motoru; arayüzden bağımsızdır ve yalnızca numpy'a
dayanır. Stereonet çizimleri `lythoskinematic.stereonet` ortak projeksiyonunu kullanır.
"""
